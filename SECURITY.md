...
**Security** tab by opening a private vulnerability report for this repository.
Do not include credentials, customer data, exploit details, or other sensitive
material in a public issue.

The protobuf files are public contracts, not a location for secrets. Never add
